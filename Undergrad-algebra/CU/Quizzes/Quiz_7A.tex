...
\noindent {\sc {\bf {\Large Quiz 7A: Complex zeros, rational functions}}
            \hfill Fall 2017}
\bigskip
...
\question[10]
Define $f(x) = x^4 - 2x^3 + 9x^2 - 18x$.  One zero of this function is $x = 3i$.  Find all remaining zeros, both real and complex.
