...
\noindent {\sc {\bf {\Large Retake 7A: Complex zeros, rational functions}}
            \hfill Fall 2017}
\bigskip
...
\question[10]
Define $f(x) = 2x^4 + 5x^3 + 5x^2 +20x - 12$.  One zero of this function is $x = -2i$.  Find all remaining zeros, both real and complex.
