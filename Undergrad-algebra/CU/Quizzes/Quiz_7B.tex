...
\noindent {\sc {\bf {\Large Quiz 7B: Complex zeros, rational functions}}
            \hfill Fall 2017}
\bigskip
...
\question[10]
Define $f(x) = x^4 + 5x^3 + 4x^2 + 20x$.  One zero of this function is $x = 2	i$.  Find all remaining zeros, both real and complex.
